...
function(nodejs_init)
    ...
    if(WIN32)
        ...
        if(NOT LIB32_CHECKSUM)
            # Node.js v22+ dropped 32-bit Windows support, so win-x86/node.lib
            # is no longer published. Skip the x86 library download gracefully.
            message(STATUS "No x86 library found in checksums (Node.js v22+ dropped 32-bit Windows support), skipping")
        else()
    ...
    if(WIN32)
        ...
        elseif(LIB32_NAME)
            ...
            message(FATAL_ERROR "32-bit build requested but no x86 Node.js library available (Node.js v22+ dropped 32-bit Windows support)")
        endif()
    else()
