...
void init_EngineConfig(nb::module_ &m)
{
    ...
    nb::class_<EngineConfig>(m, "EngineConfig", nb::is_final())
        ...
        .def_rw("max_isochrone_search_records", &EngineConfig::max_isochrone_search_records)
        .def_rw("max_isochrone_materialized_points",
                &EngineConfig::max_isochrone_materialized_points)
        .def_rw("max_isochrone_rasterization_steps",
                &EngineConfig::max_isochrone_rasterization_steps)
        .def_rw("max_isochrone_output_points", &EngineConfig::max_isochrone_output_points)
        .def_rw("max_isochrone_grid_cells", &EngineConfig::max_isochrone_grid_cells)
        .def_rw("max_isochrone_contours", &EngineConfig::max_isochrone_contours)
