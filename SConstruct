...
if sys.platform == 'darwin':	#Mac OS X
	...
	#assume dependencies are installed with homebrew, and call out to get folder locations
	import subprocess
	...
	#libxml2 should be installed by default, but can also be installed by via brew
