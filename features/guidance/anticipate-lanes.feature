...
# TODO         | a,l       | ab,bdehi,bdehi,il,il | depart,turn right,use lane straight,turn left,arrive  | ,right:true right:true right:false right:false,left:false left:false straight:true straight:true straight:false straight:false right:false right:false,left:true left:true right:false right:false, |
...
# TODO         | c,l       | cb,bdehi,bdehi,il,il | depart,turn left,use lane straight,turn left,arrive   | ,left:true left:true left:false left:false,left:false left:false straight:true straight:true straight:false straight:false right:false right:false,left:true left:true right:false right:false,     |
