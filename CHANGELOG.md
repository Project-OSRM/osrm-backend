# Unreleased
  - Changes from 6.0.0
    - Routing:
      - FIXED: Crash with assertion failure in `collapseSegregatedTurnInstructions` when processing routes near certain `type=manoeuvre` relations with `?steps=true` [#7287](https://github.com/Project-OSRM/osrm-backend/issues/7287)
    - Profiles:
