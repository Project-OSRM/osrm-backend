# Unreleased
  - Changes from 6.0.0
    - Profiles:
      - ADDED: Add exception for audible fences (`barrier=fence` with `sensory=audible` or `sensory=audio`) that deter livestock but do not block vehicles [#7331](https://github.com/Project-OSRM/osrm-backend/issues/7331)
