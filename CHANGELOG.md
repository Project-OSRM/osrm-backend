# Unreleased
  - Changes from 6.0.0
    ...
    - Misc:
      ...
      - CHANGED: Add std::format compatibility layer, using std::format when available and falling back to fmt::format for older compilers [#7251](https://github.com/Project-OSRM/osrm-backend/pull/7251)
