# Unreleased
  - Changes from 6.0.0
    ...
    - Profiles:
      - ADDED: Country-specific highway access for foot and bicycle profiles via `uselocationtags.countryspeeds` [#7038](https://github.com/Project-OSRM/osrm-backend/issues/7038)
