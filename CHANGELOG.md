# 5.20.0
  - Changes from 5.19.0:
    - Table:
      ...
      - FIXED: Fix crashing bug when using fallback_speed parameter with more sources than destinations. [#5290](https://github.com/Project-OSRM/osrm-backend/pull/5290)
    - Features:
