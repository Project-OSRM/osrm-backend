# Unreleased
  - Changes from 6.0.0
    ...
    - Profiles:
      ...
      - ADDED: Support `maxweightrating` tag as an alternative to `maxweight` for weight restrictions in car profile [#7325](https://github.com/Project-OSRM/osrm-backend/pull/7325)
